...
winit.path="/";//"/pi/0.1/";
winit.loadJS(winit.domains, winit.path+'/pi/boot/init.js?', "utf8", winit.initFail, "load init error");
winit.loadJS(winit.domains, winit.path+'/client/boot/next.js?', "utf8", winit.initFail, "load next error");
