<div class="new-page">
    ...
    <div w-class="member-wrap">
        <div on-tap="inviteMember">
            <client-app-widget-memberItem-memberItem>{avatorPath:"member-op.png",text:"添加成员", isOperation:true}</client-app-widget-memberItem-memberItem>
        </div>
        <div on-tap="deleteMember">
            <client-app-widget-memberItem-memberItem>{avatorPath:"member-op.png",text:"移除成员", isOperation:true}</client-app-widget-memberItem-memberItem>
        </div>
        {{for index,item of it.groupInfo.memberids}}
        <div style="position:relative;">
            <client-app-widget-memberItem-memberItem>{id: {{item}},gid: {{it.gid}}, avatorPath:"user.png", isOperation:false}</client-app-widget-memberItem-memberItem>
