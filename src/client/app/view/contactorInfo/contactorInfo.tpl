<div w-class="recent-history-wrap" style="position:absolute;width:100%;height:100%;top:0px;left:0px;background-color:gray;">
    <div w-class="top-main-wrap" ev-handleMoreContactor="handleMoreContactor">
        ...
        <client-app-widget-homeInfo-homeInfo>{avatorPath:"github.png",name:{{it.userInfo.name}},userId:{{it.uid}},isUser:true,isContactor:true}</client-app-widget-homeInfo-homeInfo>
    </div>
    <div w-class="detail-info-wrap">
        ...
        <div w-class="other-wrap">
            ...
            <ul w-class="ul-wrap">
                ...
                <li w-class="liItem lastLi" on-tap="startDialog">开始对话</li>
            </ul>
        </div>
    </div>
    ...
    {{end}}
    <div style="position:absolute;bottom:0;left:0;">{{it.rid}}</div>
</div>