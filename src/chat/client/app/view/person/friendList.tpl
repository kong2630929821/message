<div class="new-page">
    <div ev-back-click="goBack" ev-next-click="completeAddGroupMember">
        <widget w-tag="chat-client-app-widget1-topBar-topBar">{title:"分享"}</widget>
    </div>
    <div w-class="search-input">
        <widget w-tag="chat-client-app-widget1-input-input">{placeHolder : "搜索成员",style : "font-size:32px;color:#ccc;padding-left:82px;"}</widget>
