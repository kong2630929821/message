<div w-class="new-page" class="new-page" on-tap="closeMore">
    ...
    <div ev-change-tag="labelChangeTag" style="visibility: {{v.modulName == it.activeTab ? 'visible' : 'hidden'}}; z-index:{{v.modulName == it.activeTab ? 0 :-1}}; position:absolute;top:149px;bottom: 110px; width:100%;">
