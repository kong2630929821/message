<div class="new-page">
    ...
    <div w-class="member-wrap">
        ...
        <widget w-tag="chat-client-app-widget-memberItem-memberItem">{id: {{it.groupInfo.ownerid}},gid: {{it.gid}}, avatorPath:"../../res/images/user.png", isOwner:true}</widget>
        {{for index,item of it.groupInfo.adminids}}
            {{if item !== it.groupInfo.ownerid}}
                <widget w-tag="chat-client-app-widget-memberItem-memberItem">{id: {{item}},gid: {{it.gid}}, avatorPath:"../../res/images/user.png", isAdmin:true}</widget>
            {{end}}
        {{end}}
        ...
        {{for index,item of it.groupInfo.memberids}}
            ...
            <div style="position:relative;">
                <widget w-tag="chat-client-app-widget-memberItem-memberItem">{id: {{item}},gid: {{it.gid}}, avatorPath:"../../res/images/user.png"}</widget>
                {{if it.deleteBtn}}
