        ...
        <div w-class="apply-status-wrap">
            ...
            <div w-class="detail-wrap">
                ...
                <div ev-agree-joinGroup="agreeJoinGroup">
                    <chat-client-app-demo_view-contactList-applyUser>{id: {{v}}, chatType: "group", isActiveToGroup: true, activeToGGid:{{it.gid}}}</chat-client-app-demo_view-contactList-applyUser>
                </div>
                {{end}}
