...
export class UserAgree extends Struct {
    ...
    uid: number;
    agree: boolean;
	static _$info =  new StructInfo("chat/server/data/rpc/user.UserAgree",3838971680, null, [new FieldInfo("uid", 
...
export class FriendAlias extends Struct {
    ...
    rid: number;
    alias: string;
	static _$info =  new StructInfo("chat/server/data/rpc/user.FriendAlias",3281404534, null, [new FieldInfo("rid", 
