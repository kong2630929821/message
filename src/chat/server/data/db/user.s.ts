...
export class AccountGenerator extends Struct {
    ...
    index: string;
    currentIndex: number;
	static _$info =  new StructInfo("chat/server/data/db/user.AccountGenerator",3845367897,  new Map( [["primary","index"],["db","file"],["dbMonitor","true"],["hasmgr","false"]]), [new FieldInfo("index", 
...
export class FriendLink extends Struct {
    ...
    alias: string;
    hid: string;
	static _$info =  new StructInfo("chat/server/data/db/user.FriendLink",3103252508,  new Map( [["primary","uuid"],["db","file"],["dbMonitor","true"]]), [new FieldInfo("uuid", 
...
export class OnlineUsers extends Struct {
    ...
    uid: number;
    sessionId: number;
	static _$info =  new StructInfo("chat/server/data/db/user.OnlineUsers",1381957601,  new Map( [["primary","uid"],["db","memory"]]), [new FieldInfo("uid", 
...
export class OnlineUsersReverseIndex extends Struct {
    ...
    sessionId: number;
    uid: number;
	static _$info =  new StructInfo("chat/server/data/db/user.OnlineUsersReverseIndex",1368545686,  new Map( [["primary","sessionId"],["db","memory"]]), [new FieldInfo("sessionId", 
