...
export enum MSG_TYPE{TXT=1,IMG=2,VOICE=3,VIDEO=4,RECALL=5,NOTICE=6,RENOTICE=7,ADDUSER=8,REDENVELOPE=9 }
...
export class UserMsg extends Struct {
    ...
    read: boolean;
    cancel: boolean;
	static _$info =  new StructInfo("chat/server/data/db/message.UserMsg",3509325398, null, [new FieldInfo("sid", 
...
export class GroupMsg extends Struct {
    ...
    send: boolean;
    cancel: boolean;
	static _$info =  new StructInfo("chat/server/data/db/message.GroupMsg",643842481, null, [new FieldInfo("sid", 
new EnumType( Type.U32 ), null), new FieldInfo("mtype", 
new EnumType( Type.U8 ), null), new FieldInfo("msg", 
new EnumType( Type.Str ), null), new FieldInfo("time", 
new EnumType( Type.Usize ), null), new FieldInfo("send", 
...
export class Announcement extends Struct {
    ...
    send: boolean;
    cancel: boolean;
	static _$info =  new StructInfo("chat/server/data/db/message.Announcement",1488065635, null, [new FieldInfo("sid", 
new EnumType( Type.U32 ), null), new FieldInfo("mtype", 
new EnumType( Type.U8 ), null), new FieldInfo("msg", 
new EnumType( Type.Str ), null), new FieldInfo("time", 
new EnumType( Type.Usize ), null), new FieldInfo("send", 
...
export class UserHistory extends Struct {
    ...
    hIncId: string;
    msg: UserMsg;
	static _$info =  new StructInfo("chat/server/data/db/message.UserHistory",1894689728,  new Map( [["primary","hIncId"],["db","file"],["dbMonitor","true"]]), [new FieldInfo("hIncId", 
...
export class GroupHistory extends Struct {
    ...
    hIncId: string;
    msg: GroupMsg;
	static _$info =  new StructInfo("chat/server/data/db/message.GroupHistory",2984785667,  new Map( [["primary","hIncId"],["db","file"],["dbMonitor","true"]]), [new FieldInfo("hIncId", 
new EnumType( Type.Str ), null), new FieldInfo("msg", 
